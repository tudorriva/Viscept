...
export const PlantUMLEditor: React.FC<PlantUMLEditorProps> = ({
  code,
  onChange,
  onFormat,
}) => {
...
formatOnPaste: true,
      ...
      >
        💡 Tip: PlantUML diagrams must start with @startuml and end with @enduml. Supports class, sequence, state, and component diagrams.
      </div>
    </div>
  );
};
